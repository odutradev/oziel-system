...
const FormActions = ({ onSave, onCancel, onDelete, saveLabel = 'Salvar', cancelLabel = 'Cancelar', deleteLabel = 'Excluir', disabled = false, deleteDisabled = false, loading = false, align = 'right' }: FormActionsProps) => (
