...
import type { ContractStatusType, ContractType } from "@utils/types/models/contract";
import type { ChartsProps } from "./types";

const STATUS_COLORS = { ACTIVE: "#2e7d32", REGULAR: "#0288d1", IRREGULAR: "#ed6c02", INACTIVE: "#d32f2f" };
