...
const Treasury = () => {
    const { data, modalOpen, selectedDate, formData, handleSave, handleDelete, handleConfirm, handleOpenModal, handleCloseModal, handleFormChange, handleChangeMonth } = useTreasuryHook();
