...
export const CardValue = styled(Typography)<{ variantcolor?: "success" | "error" | "info" | "primary" | "warning" }>(({ theme, variantcolor }) => ({ color: variantcolor ? theme.palette[variantcolor].main : theme.palette.text.primary, fontWeight: 700, fontSize: "1.75rem" }));
